  ...
  const handleSubmit = (event) => {
    ...
    let second_lar =
      num1 > num2 && num1 > num3
        ...
        ? num1
        : num2;
    setSecond_Largest(second_lar);

    // let sc_largest = (num1>num2&&num1>num3) ?
    // (num2>num3?num2:num3) : (num2>num1 && num2>num3) ?
    // (num1>num3?num1:num3) : num1>num2?num1:num2;
    // setSecond_Largest(sc_largest);
  };
      ...
      <div className="panel panel-danger">
        <div className="panel-heading">
          <h3 className="panel-title">
            FIND SECOND NUMBER LARGEST - SOLUTION 3
          </h3>
        </div>
